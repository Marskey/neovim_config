...
local mappings = {
    ...
    l = {
        ...
        s = { "<cmd>lua require('telescope').extensions.aerial.aerial(require('telescope.themes').get_dropdown{previewer = false, layout_config = { width = 0.9 } })<cr>",
            "Document Symbols" },
        S = {
...
local v_mappings = {
    f = {
        ...
        ["g"] = { "<cmd>lua require('telescope.builtin').live_grep({ default_text = vim.getVisualSelection(), only_sort_text=true, additional_args = function(opts) return { \"--pcre2\" } end })<cr>",
            "Find Text" },
    }
}
